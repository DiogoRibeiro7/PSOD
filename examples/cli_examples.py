...
Examples:
  ...
  Evaluate with ground truth:
    ...
    common.add_argument('--min-cols', type=float, default=0.5, help='Min fraction of columns to use')
    common.add_argument('--max-cols', type=float, default=1.0, help='Max fraction of columns to use')
    ...
    common.add_argument('--contamination', type=float, default=0.1, help='Expected outlier fraction')
    ...
    # Evaluate command
    eval_parser = subparsers.add_parser('evaluate', parents=[common], help='Evaluate with ground truth')
