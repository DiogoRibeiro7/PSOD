...
.. raw:: html
    ...
    <div class="sphx-glr-thumbcontainer" tooltip="Basic usage example for PSOD outlier detection.">

.. only:: html

  .. image:: /auto_examples/images/thumb/sphx_glr_basic_usage_thumb.png
    :alt:

  :ref:`sphx_glr_auto_examples_basic_usage.py`

.. raw:: html

      <div class="sphx-glr-thumbnail-title">Basic usage example for PSOD outlier detection.</div>
    </div>


.. raw:: html

    <div class="sphx-glr-thumbcontainer" tooltip="This module demonstrates: - Temporal feature engineering - Sliding window approach - Trend and seasonality handling - Real-time anomaly detection - Time series visualization">

.. only:: html

  .. image:: /auto_examples/images/thumb/sphx_glr_time_series_example_thumb.png
    :alt:

  :ref:`sphx_glr_auto_examples_time_series_example.py`

.. raw:: html

      <div class="sphx-glr-thumbnail-title">Time series outlier detection examples using PSOD.</div>
    </div>


.. raw:: html

    <div class="sphx-glr-thumbcontainer" tooltip="This module demonstrates: - Custom base learners (RandomForest, XGBoost) - Different transformation algorithms - Cross-validation for threshold selection - Feature importance analysis - Parameter tuning and optimization - Model persistence (save/load)">

.. only:: html

  .. image:: /auto_examples/images/thumb/sphx_glr_advanced_usage_thumb.png
    :alt:

  :ref:`sphx_glr_auto_examples_advanced_usage.py`

.. raw:: html

      <div class="sphx-glr-thumbnail-title">Advanced usage examples for PSOD outlier detection.</div>
    </div>


.. raw:: html

    <div class="sphx-glr-thumbcontainer" tooltip="This module demonstrates how to use PSOD from the command line for various tasks: - Batch outlier detection on CSV files - Model training and saving - Scoring new data with saved models - Generating reports - Configurable via command-line arguments">

.. only:: html

  .. image:: /auto_examples/images/thumb/sphx_glr_cli_examples_thumb.png
    :alt:

  :ref:`sphx_glr_auto_examples_cli_examples.py`

.. raw:: html

      <div class="sphx-glr-thumbnail-title">Command-line interface examples for PSOD.</div>
    </div>


.. raw:: html

    <div class="sphx-glr-thumbcontainer" tooltip="This module demonstrates: - Comparison with Isolation Forest - Comparison with Local Outlier Factor (LOF) - Comparison with One-Class SVM - Comparison with Elliptic Envelope - Performance benchmarking - Visual comparison of results">

.. only:: html

  .. image:: /auto_examples/images/thumb/sphx_glr_comparison_example_thumb.png
    :alt:

  :ref:`sphx_glr_auto_examples_comparison_example.py`

.. raw:: html

      <div class="sphx-glr-thumbnail-title">Comparison of PSOD with other outlier detection methods.</div>
    </div>
